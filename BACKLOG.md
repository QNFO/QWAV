...
|:---------|:-----|:-------|:------------|:-------------------|:-------------|:-------|
| **P6** | **Q-PNA / AI side** | 🟣 SPINOFF | Specify training mechanism on Bruhat-Tits trees (loss function, backpropagation in discrete space, token calculus verification). Currently the AI side is less developed than quantum. | 2–3 | None | 🔄 ✅ DONE — v2.0 Research Specification (52 KB) published to releases by Projects thread. Now in P2 (Computational Validation). |
...
| **P44** 🟠 | **Address AGP 2006 attribution + classical/quantum scope** | 🟠 QWAV | ✅ DONE — `strategy/0.6.md` Section 3. AGP (2006) positioned as the threshold theorem QWAV geometrically specializes. Citation language drafted for next revision. Classical simulation → quantum claim bridge specified. | 1–2 | P41, P42, P43 | ✅ DONE (2026-05-18) |
