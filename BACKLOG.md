...
| **P26** | **Tier 1 computational paper** | ~~Extend Tier 0.~~ **ESSENTIALLY COMPLETE — ultrametric_v2 companion paper (`G:\My Drive\projects\ultrametric_v2\companion-paper.md`) covers: larger depths (d=2-8), realistic noise models (correlated), classical baseline comparison, q-ary generalization. Only Zenodo upload remains. See P31.** | 0.5 (upload only) | P31 (Zenodo) | ✅ ESSENTIALLY COMPLETE — companion written |
...
| **P28** | **Open-source simulation code** | Polish and release ultrametric_v2 codebase (26 files, 7 sprints): README, reproduction instructions, license. Richer than original Tier 0 repo — includes general-$p$, $q$-ary, correlated noise, classical baseline. | 1 | ultrametric_v2 codebase | NOT STARTED — scope updated |
...
| **P31** 🔴 | **Publish ultrametric_v2 companion paper to Zenodo** | Upload `companion-paper.md` (36K chars, 8 sections, 11 refs). Convert to PDF. Use metadata from ultrametric_v2 BACKLOG §A1. Get DOI. Add bidirectional cross-reference to original paper's Zenodo record. **Highest-leverage single action — unblocks P32 (needs DOI) and P33 (needs publishable reference).** | 0.5 | Web access (Zenodo login) | NOT STARTED — companion written, needs upload |
...
| **P33** 🔴 | **Refresh credential doc + narrative library with v2 findings** | Update `Ultrametric Quantum Computing Foundations.md` and `QA — Narrative Modules...md` (M1-M12) with: (a) $q$-ary 48× LER reduction, (b) correlated noise advantage, (c) 40-atom hardware spec, (d) concatenation redundancy. Add companion paper as reference. | 1-2 | P31 (for citation) | NOT STARTED |
| **P34** 🟠 | **$q$-ary scatter as standalone talking point** | Extract 48× LER reduction result into ~500-word piece. "Existing hyperfine levels multiply your error protection — at zero qubit cost." Most accessible "wow" for non-specialists. | 0.5 | None | NOT STARTED |
| **P35** 🟠 | **arXiv submission of Tier 0 paper** | Same as P23 but now strengthened by companion paper. Submit both as package or Tier 0 with companion as follow-up. | 1 | Endorser or moderator | Same as P23 — reprioritized |
| **P36** 🟡 | **Cophenetic distance as philosophical bridge** | Integrate Tree Distance Cophenetic 0.8.md framework into cross-domain synthesis paper (P27). Use triadic rigidity theorem + resolution-dependence bridge to strengthen "why trees not manifolds" argument. Cite DOI 10.5281/zenodo.20213043 once published. | 1 | Tree Distance Cophenetic Zenodo upload | NOT STARTED |
| **P37** 🟡 | **Update competitive landscape (P8) with benchmarking methodology** | Ultrametric_v2's honest classical baseline comparison (tree loses at i.i.d., wins under correlation) provides methodology template. Document who else benchmarks honestly. | 0.5 | None | NOT STARTED |
...
| **P40** 🟢 | **Cross-domain synthesis paper — updated scope (P27)** | P27 originally scoped as "ultrametricity across domains." Now has additional material: Tree Distance Cophenetic (ontology), ultrametric_v2 findings (validation depth). | 2-3 | P36, outreach responses | NOT STARTED |
