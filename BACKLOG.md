...
| **P42** 🟡 | **Investigate Heydeman et al. (2018) holographic QEC** | ✅ DONE — `strategy/0.5.2.md`. Heydeman et al. (arXiv:1812.04057) built holographic QEC codes on Bruhat-Tits trees — closest prior art, supportive of QWAV's encoding. Must be cited in next Symmetric Extension revision with explicit differentiation (holographic codes vs. passive fault tolerance). | 1 | Access to arXiv | ✅ ANALYZED (2026-05-18) |
| **P43** 🟡 | **Investigate Boettcher (2020) quantum ultra-walk** | ✅ DONE — `strategy/0.5.2.md`. Boettcher (PRR 2, 023411) showed quantum ultra-walks on Bruhat-Tits trees do NOT localize. Potential contradiction with ultrametric confinement claim. 5 reconciliation hypotheses proposed (regime difference, encoding difference, noise model, definitional, falsification). Requires simulation testing (d=5-8 depth, coherent vs. stochastic). | 1 | Access to PRR | ✅ ANALYZED (2026-05-18) |
