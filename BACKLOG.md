...
| **P13** | **IP: Draft ultrametric encoding provisional** | ⚠️ SUPERSEDED — `strategy/0.1.md` (17 claims) and `strategy/0.2.md` (25 claims) already cover this. | — | — | SUPERSEDED |
| **P14** | **IP: Quarterly review** | ⚠️ SUPERSEDED — absorbed into standing audit cycle. | — | — | SUPERSEDED |
| **P15** | **IP: Pre-filing verification** | ⚠️ SUPERSEDED — `strategy/0.2.md` covers this. | — | — | SUPERSEDED |
| **P16** | **MIT implosion carving — nanoscale 3D fabrication** | ✅ DONE — `strategy/0.7.md`. | 1 | Read paper + assess | ✅ DONE (2026-05-18) |
| **P17** | **Outreach — Zúñiga-Galindo email** | ❌ CANCELLED — email outreach not aligned with QWAV strategy. Pipeline: Zenodo → ResearchGate → QNFO.org → social distribution. Inbound-only. | — | — | CANCELLED (2026-05-18) |
| **P18** | **Outreach — Conference abstract prep** | ❌ CANCELLED — contingent on P17. | — | — | CANCELLED (2026-05-18) |
| **P19** | **Outreach — Dragovich email** | ❌ CANCELLED — email outreach not aligned with QWAV strategy. | — | — | CANCELLED (2026-05-18) |
| **P20** | **Outreach — Khrennikov email** | ❌ CANCELLED — email outreach not aligned with QWAV strategy. | — | — | CANCELLED (2026-05-18) |
| **P21** | **Outreach — David Wales email** | ❌ CANCELLED — email outreach not aligned with QWAV strategy. | — | — | CANCELLED (2026-05-18) |
| **P22** | **Outreach — Michel Planat email** | ❌ CANCELLED — email outreach not aligned with QWAV strategy. | — | — | CANCELLED (2026-05-18) |
| **P23** | **ArXiv submission** | ❌ CANCELLED — arXiv requires endorsement (gatekeeping). Zenodo is primary. See P35. | — | — | CANCELLED |
...
| **P32** 🔴 | **Neutral atom lab outreach campaign** | ❌ CANCELLED — email outreach not aligned with QWAV strategy. Templates preserved on disk (untracked, PII-protected) for reference. Pipeline: Zenodo → ResearchGate → QNFO.org → social distribution. Inbound-only. | — | — | CANCELLED (2026-05-18) |
...
| **P39** 🟢 | **Cross-reference Tree Distance Cophenetic publication** | ✅ DONE — DOI 10.5281/zenodo.20213043 cross-referenced into QWAV credential doc (ref [14]) and competitive landscape (0.5.md Ultrametric Energy Landscapes section). | 0.25 | P31 + Tree Distance Cophenetic upload | ✅ DONE (2026-05-18) |
