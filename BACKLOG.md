...
| **P31** 🔴 | **Publish ultrametric_v2 companion paper to Zenodo** | Upload companion-paper.md (36K chars, 8 sections, 11 refs). Convert to PDF. Use metadata from ultrametric_v2 BACKLOG §A1. Get DOI. Add bidirectional cross-reference to original paper’s Zenodo record. **Highest-leverage single action — unblocks P32 (needs DOI) and P33 (needs publishable reference).** **PDF GENERATED (p31-companion-paper.pdf, 94.4 KB). Upload instructions at p31-zenodo-upload-instructions.md. Awaiting human Zenodo login.** | 0.5 (0.25 done) | Web access (Zenodo login) | [~] PREPARED — PDF ready, awaiting upload |
