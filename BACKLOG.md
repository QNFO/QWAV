...
| **P41** 🟡 | **Assumption-to-physical-realizability mapping** | From "Can Math Prove Physics" close-out. Map every assumption in the p=3 ultrametric architecture to its physical realizability status (symmetric decoder, i.i.d. noise, tree geometry, branching factor). Produces "assumptions audit" for Symmetric Extension revisions. | 1–2 | Symmetric Extension paper | NOT STARTED |
| **P42** 🟡 | **Investigate Heydeman et al. (2018) holographic QEC** | Heydeman, Marcolli, Parikh, Saberi (arXiv:1812.04057) built holographic QEC codes on Bruhat-Tits trees. Must be cited and positioned against in Symmetric Extension revisions. Richard Goodman flagged as missing. | 1 | Access to arXiv | NOT STARTED |
| **P43** 🟡 | **Investigate Boettcher (2020) quantum ultra-walk** | Boettcher (PRR 2, 023411, 2020) showed quantum ultra-walks on Bruhat-Tits trees do NOT localize. Must be reconciled with ultrametric confinement claim. Richard Goodman flagged as missing. | 1 | Access to PRR | NOT STARTED |
| **P44** 🟠 | **Address AGP 2006 attribution + classical/quantum scope** | AGP 2006 (Aliferis-Gottesman-Preskill) threshold theorem for concatenated codes is the prior art the ultrametric result specializes. Not cited in Validation or Symmetric Extension papers. Also: papers are explicitly classical simulation; quantum error correction claim requires bridge. Address in next Symmetric Extension revision. | 1–2 | P41, P42, P43 | NOT STARTED |
